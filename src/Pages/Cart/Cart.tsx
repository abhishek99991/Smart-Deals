          ...
          <div className="col-70">
            <div className="flex space-bw shopping-beg-top">
              <div className="col-25 shopping-cart-img">
                <img src={ProductSmallImg} alt="Product" />
              </div>
          ...
          <div className="col-30">
            ...
            <Formik
              ...
              validationSchema={Yup.object({
                coupon: Yup.string()
                  .min(5, 'Coupon must be at least 5 characters')
                  .required('Coupon code is required'),
              })}
              onSubmit={(values) => {
                console.log('Applying coupon:', values.coupon);
              }}
            >
              {({ isSubmitting }) => (
                <Form className="cart-input-top">
                  <Field type="text" name="coupon" placeholder="Enter coupon" />
                  <ErrorMessage name="coupon" component="div" className="error" />
                  <button type="submit" className="cart-input-arrrow" disabled={isSubmitting}>
